...
void evento_caja (struct Recursos *recursos) //evento de caja sola
{
    ...
    {
        printf("Un raton te robo, perdiste 2 unidades de comida\n");
        recursos->c = recursos->c - 2;
        //-2u de comida
    } 
...
void probabilidad_eventos (struct Recursos *recursos)
{
    ...
    //las demas futuras funciones
    else
    {
        printf("Comming soon(Proximamente más funciones)");
    }
